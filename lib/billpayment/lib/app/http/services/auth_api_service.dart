...
// query parameters.
  static const String redirectUrl = ApiRoutes.baseUrl + '/';

  final authorizationEndpoint = Uri.parse(ApiRoutes.baseUrl + authorizationUrl);
  final tokenEndpoint = Uri.parse(ApiRoutes.baseUrl + refreshTokenUrl);
