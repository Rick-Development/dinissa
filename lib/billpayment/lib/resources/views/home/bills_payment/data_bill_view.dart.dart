...
class BuyDataViewtate extends State<BuyDataView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return billPaymentsController.isLoading.value
            ? const UsableLoading()
                ...
                children: [
                        ...
                        InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          const Gap(16),
                                          networkWidget(context, img: 'airtel',
                                              name: 'Airtel',
                                              action: () =>
                                              {
                                                billPaymentsController
                                                    .setNetworkLogo('airtel'),
                                                billPaymentsController
                                                    .selectedDataBundle.value =
                                                '',
                                                fetchDataBundles(),
                                          ...
                                          const Divider(
                                              color: AppColors.greyBorderColor),
                                          const Gap(16),
                                          networkWidget(context, img: '9mobile',
                                              name: '9Mobile',
                                              action: () =>
                                              {
                                                billPaymentsController
                                                    .setNetworkLogo('9mobile'),
                                                billPaymentsController
                                                    .selectedDataBundle.value =
                                                '',
                                                fetchDataBundles(),
                          ...
                          child: Row(
                            ...
                            children: [
                              Obx(() {
                                return Image.asset(
                                    'assets/images/${billPaymentsController
                                        .networkLogo.value}.png');
                              }),
                    ...
                    return SingleChildScrollView(
                      child: Column( // Wrap the content in a Column to allow vertical scrolling
                        children: [
                          CustomTextfield(
                            label: 'Select Bundle',
                            hintText: billPaymentsController.selectedDataBundle
                                .value != ''
                                ? billPaymentsController.selectedDataBundle
                                .value
                                : "Select Data bundle",
                            keyboardType: TextInputType.number,
                                                        ...
                                                        child: Column(
                                                          children: [
                                                            InkWell(
                                                              onTap: () {
                                                                print(
                                                                    'Selected Bundle: ${bundle['PRODUCT_NAME']} - ${bundle['PRODUCT_ID']}');
                                                                billPaymentsController
                                                                    .setSelectDataBundle(
                                                                    bundle['PRODUCT_NAME']);
                                                                data_bundle =
                                                                ...
                                                                ctrl.text =
                                                                    bundle['PRODUCT_ID']
                                                                        .toString();
                                                                print(
                                                                    'Selected Bundle in Controller: ${billPaymentsController
                                                                        .selectedDataBundle
                                                                        .value}');
                                                                Navigator.pop(
                                                                    context);
                  ...
                  Obx(() {
                    return
                      CustomTextfield(
                        // ctrl: ctrl,
                        hintText: '₦${billPaymentsController.dataamount.value
                            .toString()}.00',
                        readOnly: true,
                      );
                  }),
                  ...
                  primaryButton(context,
                      ...
                      onTap: () async {
                        ...
                        if (phone_controller.text.isEmpty) {
                          ...
                          Get.snackbar('Error', 'Select a plan',
                            snackPosition: SnackPosition.BOTTOM,
                            backgroundColor: Colors.red,
                            colorText: Colors.white,
                            icon: const Icon(Icons.warning_amber_rounded,
